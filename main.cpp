...
int main()
{
    initwindow(1000,700,"SNAKE GAME"); //800, 510 boarder
    snakeBody body;
    food fruit;
    int length,count=0;
    bool playing=true;
    ...
    while(1)
    {
            ...
            // BOXES
                 ...
                 setfillstyle(SOLID_FILL, RED);
                 floodfill(15,250,RED);
                 floodfill(250,15,RED);
                 floodfill(495,250,RED);
                 floodfill(250,495,RED);
                 floodfill(550,260,RED);
                 floodfill(550,10,RED);
                 floodfill(790,150,RED);
                 floodfill(550,500,RED);
                 floodfill(790,300,RED);

            // SCORE
                 settextstyle(SANS_SERIF_FONT, HORIZ_DIR, 5);
                 setcolor(GREEN);
                 outtextxy(550, 70, "LENGTH");
                 outtextxy(520, 130, "SCORE:");
